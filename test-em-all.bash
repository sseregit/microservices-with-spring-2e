...
function recreateComposite() {
  ...
  assertCurl 202 "curl -X DELETE https://$HOST:$PORT/product-composite/${productId} -s"
  assertEqual 202 $(curl -X POST -s https://$HOST:$PORT/product-composite -H "Content-Type: application/json" --data "$composite" -w "%{http_code}")
}
...
assertCurl 200 "curl -s  https://$HOST:$PORT/openapi/swagger-ui/index.html?configUrl=/v3/api-docs/swagger-config"
