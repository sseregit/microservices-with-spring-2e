...
public class ReviewServiceImpl implements ReviewService {
    ...
    public ReviewServiceImpl(ServiceUtil serviceUtil, ReviewRepository repository,
        ReviewMapper mapper, @Qualifier("jdbcScheduler") Scheduler jdbcScheduler) {
    ...
    public Flux<Review> getReviews(int productId) {
        ...
        return Mono.fromCallable(() -> internalGetReviews(productId))
            .flatMapMany(Flux::fromIterable).log(log.getName(), FINE).subscribeOn(jdbcScheduler);
    }
    ...
    public Mono<Review> createReview(Review body) {
        ...
        return Mono.fromCallable(() -> internalGetReviews(body))
            .subscribeOn(jdbcScheduler);
    }

    private Review internalGetReviews(Review body) {
        try {
